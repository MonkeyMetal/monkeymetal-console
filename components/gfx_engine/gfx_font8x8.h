/// @file gfx_font8x8.h
/// @brief Compact 8×8 bitmap font (ASCII 32–126).
/// Each character = 8 bytes (1 row per byte, MSB = left pixel).
/// 95 chars × 8 = 760 bytes total.

#pragma once
#include <stdint.h>

static const uint8_t gfx_font8x8[95][8] = {
    // ' ' (32)
